...
func main() {
	...
	opts := options.Client().ApplyURI("mongodb+srv://jleva:gmjnhoHk2vofz2S8@cabbage-order.ilyal.mongodb.net/?retryWrites=true&w=majority").SetServerAPIOptions(serverAPI)
